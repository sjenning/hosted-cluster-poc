...
cat > openshift-apiserver/openshift-apiserver-secret.yaml <<EOF 
apiVersion: v1
kind: Secret
metadata:
...
rm -f openshift-apiserver/openshift-apiserver-apiservices.yaml
...
cat >> openshift-apiserver/openshift-apiserver-apiservices.yaml <<EOF 
---
